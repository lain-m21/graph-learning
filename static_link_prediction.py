...
from graph_utils import split_graph, edgelist_to_matrix, sample_negative_links


def static_link_prediction(model, edge_list, task_config):
    ...
    for i in range(n_trials):
        ...
        edge_list_train, edge_list_test = split_graph(edge_list, test_ratio, avoid_alone=True)
        ...
        print('Re-split the graph into train and test - no duplicated links.')
        edge_list_train, edge_list_test = split_graph(edge_list, test_ratio, avoid_alone=False)
